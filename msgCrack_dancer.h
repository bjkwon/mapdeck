...
/* void Cls_OnNotify(int idcc, NMHDR *pnm) */
//#define HANDLE_WM_NOTIFY(hwnd, wParam, lParam, fn) \
//    ((fn)((int)(wParam), (NMHDR *)(lParam)), 0L)
...
/* void Cls_OnLButtonDown(UINT keyFlags, int xpt, int ypt) */
#define HANDLE_WM_LBUTTONDOWN(hwnd, wParam, lParam, fn) \
    ((fn)((UINT)(wParam), (int)(short)LOWORD(lParam), (int)(short)HIWORD(lParam)), 0L)
	
/* void Cls_OnLButtonUp(UINT keyFlags, int x, int y) */
#define HANDLE_WM_LBUTTONUP(hwnd, wParam, lParam, fn) \
    ((fn)((UINT)(wParam), (int)(short)LOWORD(lParam), (int)(short)HIWORD(lParam)), 0L)

/* void Cls_OnMouseMove(UINT keyFlags, int x, int y) */
